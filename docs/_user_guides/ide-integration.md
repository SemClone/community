---
title: MCP SEMCL.ONE IDE Integration Guide
description: Integrate the SEMCL.ONE MCP server with popular AI-powered IDEs for seamless OSS compliance analysis
date: 2025-11-24
author: SEMCL.ONE Team
tags: [mcp, ide, cursor, kiro, cline, vscode, integration, setup]
---
...
- Explore the [SEMCL.ONE toolchain](https://github.com/SemClone)
...
- [GitHub Repository](https://github.com/SemClone/mcp-semclone)
